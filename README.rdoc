...
# Looking forward your comments and suggestions! Feel free to write to +clientes at signo-net.com+

= Plugin description

This plugin modifies the _Project_ overview tab showing a random *Chuck Norris* (yeah it is actually
...
- Undo the database migration by typing +rake db:migrate:plugin NAME=redmine_chuck_norris VERSION=0+
- Remove +redmine_chuck_norris+ from your +redmine/vendor/plugins+ folder.
